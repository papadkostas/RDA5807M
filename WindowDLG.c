...
#define ID_SLIDER_1 (GUI_ID_USER + 0x1B)
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { BUTTON_CreateIndirect, "reset", ID_BUTTON_1, 155, 35, 80, 25, 0, 0x0, 0 },
  { SLIDER_CreateIndirect, "channel", ID_SLIDER_0, 5, 285, 170, 35, 0, 0x0, 0 },
  { SLIDER_CreateIndirect, "Volume", ID_SLIDER_1, 195, 65, 35, 210, 8, 0x0, 0 },
  { BUTTON_CreateIndirect, "seekdown", ID_BUTTON_2, 5, 250, 80, 25, 0, 0x0, 0 },
  { BUTTON_CreateIndirect, "seekup", ID_BUTTON_3, 95, 250, 80, 25, 0, 0x0, 0 },
  { CHECKBOX_CreateIndirect, "mute", ID_CHECKBOX_0, 185, 285, 55, 20, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "tittle", ID_TEXT_0, 5, 5, 125, 20, 0, 0x64, 0 },
  { TEXT_CreateIndirect, "text1", ID_TEXT_1, 5, 35, 80, 20, 0, 0x64, 0 },
  { TEXT_CreateIndirect, "text2", ID_TEXT_2, 85, 35, 60, 20, 0, 0x64, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_NOTIFY_PARENT:
    ...
    case ID_BUTTON_1: // Notifications sent by 'reset'
      ...
      break;
    case ID_SLIDER_0: // Notifications sent by 'channel'
      switch(NCode) {
      case WM_NOTIFICATION_CLICKED:
        // USER START (Optionally insert code for reacting on notification message)
        // USER END
      ...
      case WM_NOTIFICATION_VALUE_CHANGED:
          // USER START (Optionally insert code for reacting on notification message)
          // USER END
    	  //test = SLIDER_GetValue(ID_SLIDER_0);
        break;
      // USER START (Optionally insert additional code for further notification handling)
      // USER END
      }
      break;
    case ID_SLIDER_1: // Notifications sent by 'Volume'
      switch(NCode) {
      case WM_NOTIFICATION_CLICKED:
        // USER START (Optionally insert code for reacting on notification message)
        // USER END
